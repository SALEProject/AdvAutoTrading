...
begin
 ...
 begin
   ...
   Mem_Export.Lines.Add('SHORT   STOP:'+FormatFloat('0.00',HistoryPos.PosParams.SHORT_STOP_PERCENT)+'%'+'<BR>');
    ...
    Mem_Export.Lines.Add('ERL TRSH VMax:'+FormatFloat('0.00',HistoryPos.PosParams.PRF_PRC_ERL )+'<BR>');
    Mem_Export.Lines.Add('ERL COEF CORR:'+FormatFloat('0.00',HistoryPos.PosParams.COR_PRC_ERL )+'<BR>');
